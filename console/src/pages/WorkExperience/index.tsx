...
interface DetailDrawerProps {
  ...
  duplicates:
    | import("@/api/modules/workExperience").DuplicateDetectionResponse
    | null;
...
function DetailDrawer({
  ...
  const canPromote =
    card.experience_level === "new" || card.experience_level === "observed";
  const canDemote =
    card.experience_level === "observed" || card.experience_level === "mature";
  ...
  const duplicateOptions =
    duplicates?.duplicates.map((d) => ({
      label: `${d.title} (${d.trigger_hint}) — ${t(
        "workExperience.maturityScore",
        ...
        {loading ? (
          ...
          <>
              ...
              >
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.maturityScore")}:{" "}
                  </span>
                  {card.maturity_score.toFixed(1)}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.successRate")}:{" "}
                  </span>
                  {(card.success_rate_estimate * 100).toFixed(0)}%
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.effectiveRatio")}:{" "}
                  </span>
                  {card.effective_count > 0
                    ? (card.effective_count / card.hit_count).toFixed(2)
                    : "—"}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.scope")}:{" "}
                  </span>
                  {getScopeLabel(t, card.scope)}
                </div>
              </div>
            </div>
            ...
            {(card.usage_pattern_summary ||
              ...
              <div className={styles.drawerSection}>
                <div className={styles.drawerSectionTitle}>
                  {t("workExperience.workGuidance")}
                </div>
                {card.usage_pattern_summary && (
                  <div className={styles.drawerField}>
                    <div className={styles.drawerFieldLabel}>
                      {t("workExperience.patternSummary")}
                    </div>
                ...
                {card.recommended_tool_order.length > 0 && (
                  <div className={styles.drawerField}>
                    <div className={styles.drawerFieldLabel}>
                      {t("workExperience.recommendedTools")}
                    </div>
                ...
                {card.recommended_workflow.length > 0 && (
                  <div className={styles.drawerField}>
                    <div className={styles.drawerFieldLabel}>
                      {t("workExperience.recommendedWorkflow")}
                    </div>
                    <div className={styles.tagList}>
            ...
            <div className={styles.drawerSection}>
              <div className={styles.drawerSectionTitle}>
                {t("workExperience.trigger")}
              </div>
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldHint")}
                </div>
                <div className={styles.drawerFieldValue}>
                  {card.trigger_hint}
                </div>
              ...
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldKeywords")}
                </div>
                <div className={styles.tagList}>
                  {card.trigger_keywords.map((k: string) => (
                    <Tag key={k} className={styles.keywordTag} color="purple">
                      {k}
                    </Tag>
                  ))}
                </div>
              ...
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldApplicabilityTags")}
                </div>
                <div className={styles.tagList}>
                  {card.applicability_tags.map((tag: string) => (
                    <Tag key={tag} className={styles.actionTag}>
                      {tag}
                    </Tag>
                  ))}
                </div>
            ...
            <div className={styles.drawerSection}>
              ...
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldWhatHappened")}
                </div>
                <div className={styles.drawerFieldValue}>
                  {card.what_happened}
                </div>
              ...
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldGuidance")}
                </div>
                <div className={styles.drawerFieldValue}>{card.guidance}</div>
              </div>
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldWhatWorked")}
                </div>
                <div className={styles.tagList}>
                  {card.what_worked.map((w: string) => (
                    <Tag key={w} color="green" className={styles.actionTag}>
                      {w}
                    </Tag>
                  ))}
                </div>
              ...
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldWhatFailed")}
                </div>
                <div className={styles.tagList}>
                  {card.what_failed.map((f: string) => (
                    <Tag key={f} color="red" className={styles.actionTag}>
                      {f}
                    </Tag>
                  ))}
                </div>
              ...
              <div className={styles.drawerField}>
                <div className={styles.drawerFieldLabel}>
                  {t("workExperience.fieldAvoidance")}
                </div>
            ...
            <div className={styles.drawerSection}>
              ...
              >
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.hitCount")}:{" "}
                  </span>
                  {card.hit_count}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.effectiveCount")}:{" "}
                  </span>
                  {card.effective_count}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.confidence")}:{" "}
                  </span>
                  {card.confidence.toFixed(2)}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.qualityScore")}:{" "}
                  </span>
                  {card.quality_score.toFixed(3)}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldLastRetrieved")}:{" "}
                  </span>
                  {formatDate(card.last_retrieved_at)}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldLastUsed")}:{" "}
                  </span>
            ...
            <div className={styles.drawerSection}>
              ...
              >
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldCardId")}:{" "}
                  </span>
                  <code>{card.experience_id}</code>
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldSourceTask")}:{" "}
                  </span>
                  {card.source_task_id}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldSession")}:{" "}
                  </span>
                  {card.source_session_id}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldCreated")}:{" "}
                  </span>
                  {formatDate(card.created_at)}
                </div>
                <div>
                  <span style={{ color: "#999" }}>
                    {t("workExperience.fieldUpdated")}:{" "}
                  </span>
            ...
            <div className={styles.drawerSection}>
              <div className={styles.drawerSectionTitle}>
                {t("workExperience.levelTransitions")}
              </div>
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {canPromote && (
                  <Button
                    ...
                    onClick={() => onLevelAction(card.experience_id, "promote")}
                  >
                ...
                {canDemote && (
                  <Button
                    ...
                    onClick={() => onLevelAction(card.experience_id, "demote")}
                  >
                ...
                {canDeprecate && (
                  <Button
                    ...
                    icon={<StopOutlined />}
                    onClick={() =>
                      onLevelAction(card.experience_id, "deprecate")
                    }
                  >
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {canApprove && (
                  <Button
                    ...
                    onClick={() =>
                      onStatusAction(card.experience_id, "approve")
                    }
                  >
                ...
                {canReject && (
                  <Button
                    ...
                    onClick={() => onStatusAction(card.experience_id, "reject")}
                  >
                ...
                {canArchive && (
                  <Button
                    ...
                    icon={<InboxOutlined />}
                    onClick={() =>
                      onStatusAction(card.experience_id, "archive")
                    }
                  >
                ...
                {canReactivate && (
                  <Button
                    ...
                    icon={<ReloadOutlined />}
                    onClick={() =>
                      onStatusAction(card.experience_id, "reactivate")
                    }
                  >
            ...
            <div className={styles.drawerSection}>
              <div className={styles.drawerSectionTitle}>
                {t("workExperience.potentialDuplicates")} (
                {duplicates?.count ?? 0})
              </div>
              {duplicatesLoading ? (
                ...
                <>
                  {duplicates.duplicates.map((dup) => (
                    <div
                      key={dup.experience_id}
                      className={styles.duplicateCard}
                    >
                      <div className={styles.duplicateTitle}>{dup.title}</div>
                      <div className={styles.duplicateMeta}>
                        {dup.trigger_hint} · {t("workExperience.maturityScore")}
                        : {dup.maturity_score.toFixed(1)} ·{" "}
                        <LevelBadge level={dup.experience_level} t={t} />
                      </div>
                    </div>
                  ))}
                  <Button
                ...
                <div style={{ color: "#999", fontSize: 13 }}>
                  {t("workExperience.noDuplicatesFound")}
                </div>
              )}
              {!duplicates && !duplicatesLoading && (
                <Button
                  icon={<EyeOutlined />}
                  onClick={() => onShowDuplicates(card.experience_id)}
                >
    ...
    <div className={styles.statsBar}>
      ...
      <div className={styles.statCard}>
        ...
        <div className={styles.statLabel}>
          {t("workExperience.levelMature")}
        </div>
      </div>
      <div className={styles.statCard}>
        <div className={styles.statValue}>
          {stats.by_level["observed"] ?? 0}
        </div>
        <div className={styles.statLabel}>
          {t("workExperience.levelObserved")}
        </div>
      </div>
      <div className={styles.statCard}>
    ...
    () => [
      ...
      },
      {
        ...
        render: (_: unknown, record: WorkExperienceCard) => (
          <Button
            size="small"
            onClick={() => fetchCardDetail(record.experience_id)}
          >
  ...
  return (
    <>
      ...
      <div className={styles.workExperiencePage}>
        <PageHeader
          parent={t("nav.agent")}
          current={t("workExperience.pageTitle")}
        />
          ...
          <div className={styles.filterGroup}>
            ...
            <Select
              ...
              onChange={(val) =>
                handleFilterChange(
                  statusFilter,
                  val as "all" | "new" | "observed" | "mature" | "deprecated",
                  scopeFilter,
                  false,
                )
              }
            ...
            <Select
              ...
              onChange={(val) =>
                handleFilterChange(
                  statusFilter,
                  levelFilter,
                  val as "all" | "global" | "user" | "project" | "session",
                  false,
                )
              }
            />
          ...
          <Table
            ...
            pagination={{
              ...
              showTotal: (tot: number) =>
                `${tot} ${t("workExperience.totalCardsLabel")}`,
