  ...
  const handleSubmit = async () => {
    try {
      ...
      if (editingAgent) {
        ...
        // Skill downloads are non-blocking: failures show honest warning but don't
        // block the main agent update. This prevents the confusing "save failed" when
        // the core update actually succeeded.
