      ...
      ? [
          {
            ...
            path: "/admin/sessions",
            label: t("nav.adminSessions", "All sessions"),
          },
        ]
      : []),
  ];
  ...
  const menuItems: MenuProps["items"] = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          key: "work-experience",
          label: collapsed ? null : t("nav.workExperience"),
          icon: <SparkMagicWandLine size={16} />,
        },
        {
          key: "agent-config",
    ...
    ...(isAdmin
      ? [
          {
            key: "admin-group",
            label: collapsed ? null : t("nav.adminGroup", "Admin"),
            children: [
              {
                key: "admin-sessions",
                label: collapsed
                  ? null
                  : t("nav.adminSessions", "All sessions"),
