...
[Provide the version of HubOS you are using, e.g. 0.x.x or git commit hash.]
[Using `hubos --version` in your command line or checking the version in the console UI can help.]
...
- **HubOS version:** [e.g. 0.x.x or git commit]
