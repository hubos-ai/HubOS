...
from hubos.providers.provider import (
    ModelInfo,
    Provider,
    ProviderInfo,
)
...
from hubos.providers.gemini_provider import GeminiProvider
from hubos.providers.ollama_provider import OllamaProvider
...
class ProviderManager:
    ...
    def _init_builtins(self):
        self._add_builtin(PROVIDER_HUBOS)
    ...
    async def _resume_local_model(self, local_manager) -> None:
        ...
        local_models = self.get_provider("hubos-local").extra_models
