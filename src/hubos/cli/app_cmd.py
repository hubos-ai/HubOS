...
def app_cmd(
    ...
    if workers is not None:
        ...
        click.echo(
            "   HubOS always uses 1 worker for stability. "
    ...
    if reload:
        os.environ["HUBOS_RELOAD_MODE"] = "1"
    else:
        os.environ.pop("HUBOS_RELOAD_MODE", None)
