...
@click.group(
    ...
    lazy_subcommands={
        "app": ("hubos.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "hubos.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("hubos.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("hubos.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("hubos.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("hubos.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("hubos.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("hubos.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("hubos.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "hubos.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("hubos.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "hubos.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("hubos.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("hubos.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "hubos.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("hubos.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("hubos.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("hubos.cli.agents_cmd", "agents_group", ".agents_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="HubOS")
