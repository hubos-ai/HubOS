# -*- coding: utf-8 -*-
"""CLI command: run HubOS app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run HubOS app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing HubOS app instance.
    """
    ...
    click.echo(f"Starting HubOS app on {url} (port {port})")
