...
# mypy: ignore-errors
"""ReMeLight-backed memory manager for HubOS agents."""
...
from hubos.config.context import (
    set_current_workspace_dir,
    set_current_recent_max_bytes,
)
from hubos.constant import EnvVarLoader
...
class ReMeLightMemoryManager(BaseMemoryManager):
    """Memory manager that wraps ReMeLight for HubOS agents via composition.
        ...
        **_kwargs,
        ...
        if extra_instruction:
            result = await self._reme.compact_memory(
                ...
                as_token_counter=get_hubos_token_counter(agent_config),
