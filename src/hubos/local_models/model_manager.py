...
class ModelManager:
    ...
    def get_recommended_models(self) -> list[LocalModelInfo]:
        ...
        if memory_gb <= 8:
            models = [
                LocalModelInfo(
                    id="AgentScope/HubOS-Flash-2B-Q4_K_M",
                    name="HubOS-Flash-2B-Q4_K_M",
                    size_bytes=1560460768,
                    source=DownloadSource.MODELSCOPE,
                ),
                LocalModelInfo(
                    id="AgentScope/HubOS-Flash-2B-Q8_0",
                    name="HubOS-Flash-2B-Q8_0",
            ...
            models = [
                LocalModelInfo(
                    id="AgentScope/HubOS-Flash-4B-Q4_K_M",
                    name="HubOS-Flash-4B-Q4_K_M",
                    size_bytes=3066384736,
                    source=DownloadSource.MODELSCOPE,
                ),
                LocalModelInfo(
                    id="AgentScope/HubOS-Flash-4B-Q8_0",
                    name="HubOS-Flash-4B-Q8_0",
            ...
            models = [
                LocalModelInfo(
                    id="AgentScope/HubOS-Flash-9B-Q4_K_M",
                    name="HubOS-Flash-9B-Q4_K_M",
                    size_bytes=5476080128,
                    source=DownloadSource.MODELSCOPE,
                ),
                LocalModelInfo(
                    id="AgentScope/HubOS-Flash-9B-Q8_0",
                    name="HubOS-Flash-9B-Q8_0",
    ...
    def download_model(
        ...
        with self._lock:
            ...
            self._process = self._context.Process(
                ...
                name=f"hubos-model-download-{task_id}",
                daemon=True,
            )
            ...
            self._monitor_thread = threading.Thread(
                ...
                name=f"hubos-model-download-monitor-{task_id}",
                daemon=True,
            )
