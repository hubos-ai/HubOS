...
from hubos.constant import DEFAULT_LOCAL_PROVIDER_DIR
...
class LlamaCppBackend:
    """
    HubOS local model backend for managing llama.cpp server installation
    and setup.
    """
