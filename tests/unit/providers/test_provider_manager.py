...
import hubos.providers.provider_manager as provider_manager_module
from hubos.providers.anthropic_provider import AnthropicProvider
from hubos.providers.models import ModelSlotConfig
from hubos.providers.openai_provider import OpenAIProvider
from hubos.providers.provider import ModelInfo
from hubos.providers.provider_manager import ProviderManager
...
def isolated_secret_dir(monkeypatch, tmp_path):
    secret_dir = tmp_path / ".hubos.secret"
...
async def test_resume_local_model_restores_server_and_runtime_state(
    ...
    manager = ProviderManager()
    model_id = "AgentScope/HubOS-flash-2B-Q4_K_M"
    ...
    provider = manager.get_provider("hubos-local")
