...
from hubos.local_models.download_manager import (
    DownloadProgressTracker,
    DownloadTaskStatus,
)
from hubos.local_models.model_manager import ModelManager, DownloadSource
...
def test_download_model_uses_reachable_source(
    ...
    monkeypatch.setattr(
        "hubos.local_models.model_manager.threading.Thread",
        _FakeThread,
    )
